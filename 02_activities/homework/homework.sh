...
cp dir1/file.txt dir3/file.txt
cp dir1/file.txt dir4/file.txt
cp dir1/file.txt dir5/file.txt
...
rm dir2/file.txt dir3/file.txt dir4/file.txt dir5/file.txt

# 8. How would you navigate back to the parent directory containing all the directories?
cd .. until you get the right directory or
cd full_path_to_the_directory
